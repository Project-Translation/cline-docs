...
2. **提供上下文**
    ...
    - 详情请参见[提及功能指南](./mentions-guide.md)
...
有关最新的实现细节，您可以查看 [Cline 仓库](https://github.com/cline/cline/blob/main/src/core/task/index.ts) 中的完整源代码。

Cline 可以访问以下工具，用于各种任务：
...
- 开始带有上下文的新任务 (new_task)：
    ```xml
    <new_task>
    <context>
    我们已经完成了后端 API，包含以下端点：
    - GET /api/tasks
    - POST /api/tasks
    - PUT /api/tasks/:id
    - DELETE /api/tasks/:id
